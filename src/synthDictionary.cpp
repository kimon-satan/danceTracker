...
string synthDictionary::getSelectorString(int sType){
    
    switch(sType){
            
        case SELT_RANDOM:return "random";
        case SELT_SERIAL:return "serial";
        case SELT_PINGPONG:return "pingPong";
        case SELT_WRAP:return "wrap";
        default: return "";
    }
